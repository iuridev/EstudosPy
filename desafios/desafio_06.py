...
senhas dos usuários no IAM são fracas e podem representar um risco à segurança 
dos dados da empresa. Para resolver esse problema, foi solicitado que você 
desenvolva um programa capaz de analisar as senhas dos usuários e fornecer uma 
validação de força com base em critérios predefinidos.
...
# Verificando se a senha contém sequências comuns
  ...
  if tem_numero == True and tem_letra_maiuscula == True and tem_letra_minuscula == True and tem_caractere_especial == True:
