...
def prever_afinidade_elemental(intensidade, componente_raro, fase_lunar, idade_feiticeiro, afinidade_animais):
    ...
    elif intensidade >= 7 and fase_lunar == "cheia" and idade_feiticeiro <= 100 and componente_raro == True and afinidade_animais == True:
        return "A afinidade elemental do feiticeiro é com o elemento Terra!"
    elif intensidade >= 7 and fase_lunar == "cheia" and idade_feiticeiro <= 100 and componente_raro == True and afinidade_animais == False:
